...
public class rightnowticketTest extends setup {

	@Test
	public void Culture_rightnowticket() throws Exception {
		driver.get("http://www.wemakeprice.com/main/980600");
