...
public class hotelTest {
	...
	@Test
	public void Tour_hotel() throws Exception {
		driver.get("http://www.wemakeprice.com/main/990300");
			...
			for (int a = 0; a < 1; a++) {
				...
				while (i < rbc) {
					...
					if (driver.getCurrentUrl().contains("404")) {
						takeScreenshotofpage(driver, screenpath + getDateTimeStamp() + "_Failcase."
